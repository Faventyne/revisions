...
Notre projet projobjects est actuellement ouvert à tout utilisateur.
...
Une fois connecté, il faut ajouter en SESSION, au moins, l'id et le role de l'utilisateur.
