...
--
-- Client :  localhost
-- Généré le :  Lun 16 Octobre 2017 à 10:55
...
DROP TABLE IF EXISTS `session_has_trainer`;
...
(1, 'front', '2017-06-15 07:55:43'),
(2, 'back', '2017-06-15 07:55:43'),
...
--
ALTER TABLE `country`
  MODIFY `cou_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
